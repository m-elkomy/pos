                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">@lang('admin.users')</li>
                    ...
                    <div class="col-12">
                        <div class="card card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-2">{{$title}}<small> {{$users->total()}}</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @if(auth()->user()->hasPermission('create_users'))
                                                <a href="{{route('admin.users.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('admin.add')</a>
                                            @else
                                ...
                                @if($users->count() > 0)
                                    <table class="table table-hover table-bordered">
                                        ...
                                        @foreach($users as $index=>$user)
                                            <tr>
                                                <td>{{$index + 1}}</td>
                                                <td><img src="{{$user->image_path}}" width="50px" height="50px" class="img-thumbnail"></td>
                                                <td>{{$user->name}}</td>
                                                <td>{{$user->email}}</td>
                                                <td>
                                                    @if(auth()->user()->hasPermission('update_users'))
                                                        <a href="{{route('admin.users.edit',$user->id)}}" class="btn btn-primary"><i class="fa fa-edit"></i> @lang('admin.edit')</a>
                                                    @else
                                                        <a href="" class="btn btn-primary disabled"><i class="fa fa-plus"></i> @lang('admin.add')</a>
                                                    @endif
